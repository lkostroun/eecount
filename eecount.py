# much thanks to https://www.scrapehero.com/tutorial-scraping-linkedin-for-public-company-data/
...
def get_company_size_from_url(url):
    extracted_data = []
    extracted_data.append(linkedin_companies_parser(url))
    return extracted_data[0]['size']
